...
export default class Imran extends React.Component{
  ...
  componentDidMount(){
    ...
    db.collection('Candidates').where('Name' , '==' , 'Shahbaz Sharif')
    .onSnapshot((snapshot)=>{
  ...
  render(){
    ...
    return(
      ...
      <Headercomp title="Shahbaz Sharif"/>
      <ScrollView>
      <View style={{alignItems:'center'}}>
   
        <ImageBackground style={styles.pro} source={require('../assets/pmlnFlag.jpg')}>
          
       
      
    
      <View>
      <Image  style={styles.candidate} source={require('../assets/shahbaz.jpg')} ></Image>

    </View>
    
    </ImageBackground>
    <View style={styles.name} >
     <Text style={styles.title} >Shahbaz Sharif</Text>
     </View>
