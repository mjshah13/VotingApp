...
export default class Imran extends React.Component{
  ...
  componentDidMount(){
    ...
    db.collection('Candidates').where('Name' , '==' , 'Imran Khan')
    .onSnapshot((snapshot)=>{
  ...
  render(){
    ...
    return(
      ...
      // <View  style={{width:'100%',marginBottom:0,marginTop:0}}>       </View>
      
      
      <View style={styles.Container}>
      <Headercomp title={'Imran Khan'} />
          <ScrollView>

          <View style={{alignItems: 'center'}}>
                <ImageBackground style={styles.pro} source={require('../assets/pti.jpg')}>
                  
              
              
            
              <View>
              <Image  style={styles.candidate} source={require('../assets/imran.jpg')} ></Image>

            </View>
            
            </ImageBackground>
            <View style={styles.name} >
            <Text style={styles.title} >Imran Khan Niyazi</Text>
            </View>
